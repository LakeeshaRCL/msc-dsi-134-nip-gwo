...
```
Other wolves in the population are the **omega** wolves
...
view_best_wolves(x_alpha, x_beta, x_delta)
```
After the optimization of one iteration, **delta wolf is unchanged**. However, the **beta wolf became the delta wolf** and the **delt wolf became the new beta wolf**.
The **gamma wolf is unchanged**.
